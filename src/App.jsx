...
function App() {
  ...
  const skills = [
    ...
    { id: 4, title: "React", imageUrl: "/assets/svg/React.svg", experience: "2 years", description: "Lorem ipsum dolor sit amet...", description: "Tanto como HTML y CSS, he trabajado con JavaScript desde la preparatoria. Tengo gran experiencia con el manejo del DOM, lo que me permite crear interacciones dinámicas y mejorar la experiencia del usuario en las páginas web. Actualmente, estoy utilizando varias extensiones como React y estudiando TypeScript para mejorar mis habilidades y escribir código más seguro y mantenible.", description2:"JavaScript es uno de los lenguajes que más conozco y en el que tengo más experiencia. He desarrollado numerosos proyectos, tanto personales como académicos, que me han permitido consolidar mis conocimientos y habilidades. Estoy siempre en busca de nuevas técnicas y mejores prácticas para seguir mejorando como desarrollador." },
    { id: 5, title: "Node.js", imageUrl: "/assets/svg/Node.js.svg", experience: "2 years", description: "En general, conozco lo básico de Node.js, pero estoy en proceso de aprender más sobre este entorno de ejecución. A pesar de ello, tengo conocimientos sólidos sobre los conceptos fundamentales y he trabajado en algunos proyectos que me han permitido aplicar estos conocimientos en la práctica. Estoy motivado a seguir aprendiendo y mejorando mis habilidades en Node.js para poder desarrollar aplicaciones del lado del servidor de manera eficiente y escalable.", description2:""},
    { id: 6, title: "Git", imageUrl: "/assets/svg/Git.svg", experience: "3 years", description: "Lorem ipsum dolor sit amet...", description2:""},
    { id: 7, title: "GitHub", imageUrl: "/assets/svg/GitHub.svg", experience: "3 years", description: "Lorem ipsum dolor sit amet...", description2:""},
    { id: 8, title: "Python", imageUrl: "/assets/svg/Python.svg", experience: "1 year", description: "Lorem ipsum dolor sit amet...", description2:""},
    { id: 9, title: "Java", imageUrl: "/assets/svg/Java.svg", experience: "2 years", description: "Lorem ipsum dolor sit amet...", description2:"" },
    { id: 10, title: "PHP", imageUrl: "/assets/svg/PHP.svg", experience: "1 year", description: "Lorem ipsum dolor sit amet...", description2:"" },
    { id: 11, title: "MySQL", imageUrl: "/assets/svg/MySQL.svg", experience: "2 years", description: "Lorem ipsum dolor sit amet...", description2:"" },
    { id: 12, title: "Microsoft SQL", imageUrl: "/assets/svg/Microsoft SQL Server.svg", experience: "1 year", description: "Lorem ipsum dolor sit amet...", description2:"" },
    { id: 13, title: "Linux", imageUrl: "/assets/svg/Linux.svg", experience: "2 years", description: "Lorem ipsum dolor sit amet...", description2:"" },
    { id: 14, title: "Windows", imageUrl: "/assets/svg/Windows 8.svg", experience: "5 years", description: "Lorem ipsum dolor sit amet...", description2:"" }
  ];
