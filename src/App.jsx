...
function App() {
  ...
  const skills = [
    { id: 1, title: "HTML", imageUrl: "/assets/svg/HTML5.svg", experience: "3 years", description: "He tenido mucha experiencia utilizando HTML tanto en proyectos escolares como en proyectos personales. Mayormente, he trabajado con páginas estáticas y estoy familiarizado con la gran mayoría de atributos y etiquetas de HTML. Además, sé estructurar bien las páginas, asegurando que el código sea limpio y semántico. He creado sitios web responsivos utilizando CSS para asegurar que se vean bien en diferentes dispositivos y he incorporado JavaScript para agregar interactividad. Estoy comprometido con seguir aprendiendo y mejorando mis habilidades en desarrollo web para crear experiencias de usuario óptimas." },
    { id: 2, title: "CSS", imageUrl: "/assets/svg/CSS3.svg", experience: "4 years", description: "Tengo una amplia experiencia utilizando CSS para diseñar y estilizar páginas web. A lo largo de varios proyectos escolares y personales, he aprendido a manejar eficientemente las propiedades de CSS para crear diseños atractivos y responsivos. Estoy familiarizado con conceptos avanzados como el modelo de caja, la flexbox, y la grid layout, lo que me permite estructurar y organizar el contenido de manera efectiva" },
    { id: 3, title: "JavaScript", imageUrl: "/assets/svg/JavaScript.svg", experience: "3 years", description: "He tenido experiencia con React desde hace unos meses, trabajando en diversos proyectos personales. Conozco bien la creación de componentes y su implementación, lo que me permite construir aplicaciones web modulares y reutilizables. Mayormente, desarrollo estos proyectos utilizando Vite y JavaScript. Además, estoy en proceso de aprender TypeScript para mejorar aún más mis habilidades y escribir código más robusto y tipado. Ya tengo la habilidad de crear páginas dinámicas y no estáticas, lo que me permite desarrollar aplicaciones web interactivas y con un mejor rendimiento. Estoy comprometido con seguir aprendiendo y perfeccionando mis conocimientos en React para crear aplicaciones eficientes y escalables." },
